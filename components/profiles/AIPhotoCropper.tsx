...
export default function AIPhotoCropper({ onPhotoSelect, uploadCount }: AIPhotoCropperProps) {
  ...
  const handleImageSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (uploadCount >= 75) {
      alert('âš ï¸ à¦†à¦ªà¦¨à¦¿ à§­à§«à¦Ÿà¦¿ à¦›à¦¬à¦¿ à¦†à¦ªà¦²à§‹à¦¡ à¦•à¦°à§‡à¦›à§‡à¦¨!\n\nà¦¸à¦°à§à¦¬à§‹à¦šà§à¦š 8ti à¦›à¦¬à¦¿ à¦†à¦ªà¦²à§‹à¦¡ à¦•à¦°à¦¾ à¦¯à¦¾à¦¬à§‡à¥¤\n\nYou have uploaded 75 photos! Maximum 8 photos allowed.');
    }

    if (uploadCount >= 8) {
      alert('âŒ à¦¸à¦°à§à¦¬à§‹à¦šà§à¦š à¦¸à§€à¦®à¦¾ à¦ªà§Œà¦à¦›à§‡à¦›à§‡!\n\n8ti à¦›à¦¬à¦¿à¦° à¦¬à§‡à¦¶à¦¿ à¦†à¦ªà¦²à§‹à¦¡ à¦•à¦°à¦¾ à¦¯à¦¾à¦¬à§‡ à¦¨à¦¾à¥¤\n\nMaximum limit reached! Cannot upload more than 8 photos.');
      return;
    }
