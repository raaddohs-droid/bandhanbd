...
export default function AIPhotoCropper({ onPhotoSelect, uploadCount }: AIPhotoCropperProps) {
  ...
  const handleImageSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (uploadCount >= 75) {
      alert('ÔÜá´©Å ÓªåÓª¬Óª¿Óª┐ Óº¡Óº½ÓªƒÓª┐ ÓªøÓª¼Óª┐ ÓªåÓª¬Óª▓ÓºïÓªí ÓªòÓª░ÓºçÓªøÓºçÓª¿!\n\nÓª©Óª░ÓºìÓª¼ÓºïÓªÜÓºìÓªÜ Óº«ÓºªÓªƒÓª┐ ÓªøÓª¼Óª┐ ÓªåÓª¬Óª▓ÓºïÓªí ÓªòÓª░Óª¥ Óª»Óª¥Óª¼ÓºçÓÑñ\n\nYou have uploaded 75 photos! Maximum 80 photos allowed.');
    }

    if (uploadCount >= 80) {
      alert('ÔØî Óª©Óª░ÓºìÓª¼ÓºïÓªÜÓºìÓªÜ Óª©ÓºÇÓª«Óª¥ Óª¬ÓºîÓªüÓªøÓºçÓªøÓºç!\n\nÓº«ÓºªÓªƒÓª┐ ÓªøÓª¼Óª┐Óª░ Óª¼ÓºçÓªÂÓª┐ ÓªåÓª¬Óª▓ÓºïÓªí ÓªòÓª░Óª¥ Óª»Óª¥Óª¼Óºç Óª¿Óª¥ÓÑñ\n\nMaximum limit reached! Cannot upload more than 80 photos.');
      return;
    }
        ...
        <label className="block cursor-pointer">
          <div className="border-4 border-dashed border-rose-300 rounded-2xl p-8 text-center hover:border-rose-500 transition bg-white">
            ...
            <p className="text-xl font-bold text-gray-900 mb-2">
              ÓªøÓª¼Óª┐ ÓªåÓª¬Óª▓ÓºïÓªí ÓªòÓª░ÓºüÓª¿ / Upload Photo
            </p>
        ...
        <div className="space-y-4">
          {isProcessing ? (
            <div className="bg-blue-50 border-2 border-blue-300 rounded-2xl p-8 text-center">
              <div className="text-4xl mb-4">­ƒöä</div>
